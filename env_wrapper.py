...
class FrameStack(gym.Wrapper):
    def __init__(self, env, k):
        ...
        self.observation_space = spaces.Box(low=0, high=255, shape=(k * shp[2], shp[0], shp[1]))  # TODO
...
class LazyFrames(object):
    ...
    def __array__(self, dtype=None):
        out = np.concatenate(self._frames, axis=2)  # TODO
        out = out.transpose([2, 0, 1])  # TODO
